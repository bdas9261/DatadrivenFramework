...
public class BusinessAdvisorObjects {
	...
	public static By tdPostFirstRowTargetDate = By.xpath("(//*[@aria-describedby='baPostLaunch_TargetDate'])[1]");
	public static By tdPostSecondRowTargetDate = By.xpath("(//*[@aria-describedby='baPostLaunch_TargetDate'])[2]");
	public static By tdPostThirdRowTargetDate = By.xpath("(//*[@aria-describedby='baPostLaunch_TargetDate'])[3]");
	
	public static By tdPostFirstPlannedAction = By.xpath("(//*[@aria-describedby='baPostLaunch_PlannedAction'])[1]");
	
	
	public static By txtCreateBA_BAHeadCnt = By.id("NewBAProgram_BAHeadCount");
	public static By txtCreateBA_Level1 = By.id("NewBAProgram_LevelI");
	public static By txtCreateBA_Level2 = By.id("NewBAProgram_LevelII");
	public static By txtCreateBA_Level3 = By.id("NewBAProgram_LevelIII");
	public static By txtCreateBA_Level4 = By.id("NewBAProgram_LevelIV");
	public static By txtCreateBA_PortManager = By.id("NewBAProgram_PortfolioManager");
	public static By txtCreateBA_SDL = By.id("NewBAProgram_SDL");
	public static By txtCreateBA_SDLLead = By.id("NewBAProgram_SDOLead");
	public static By txtCreateBA_SDLSponsor = By.id("NewBAProgram_SDOSponsor");
	public static By txtCreateBA_DealPOC = By.id("NewBAProgram_DealPOC");
	public static By txtCreateBA_HrPOC = By.id("NewBAProgram_HRPOC");
	public static By txtCreateBA_CdPOC = By.id("NewBAProgram_CDPOC");
